          ...
          >
            <div className="space-y-2">
              ...
              <p className="text-lg text-muted-foreground">
                Full Stack Developer &amp; Machine Learning Enthusiast. I build modern web apps and AI solutions.
              </p>
            </div>
            ...
            <div className="flex gap-3 mt-4">
              <a href="mailto:lohitha0801@gmail.com" target="_blank" rel="noopener noreferrer">
                <Mail className="h-6 w-6 text-primary hover:text-primary/80" />
              </a>
              <a href="tel:6303197497" target="_blank" rel="noopener noreferrer">
                <Phone className="h-6 w-6 text-primary hover:text-primary/80" />
              </a>
              <a href="https://github.com/Lohitha0011" target="_blank" rel="noopener noreferrer">
                <Github className="h-6 w-6 text-primary hover:text-primary/80" />
              </a>
              <a href="https://linkedin.com/in/lohithabonthu" target="_blank" rel="noopener noreferrer">
